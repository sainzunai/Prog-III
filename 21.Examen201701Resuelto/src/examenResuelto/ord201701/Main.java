	...
	public static class HiloCambioPantalla extends Thread {
		...
		public void run() {
			...
			while (enMarcha) {
				...
				try { Thread.sleep( 100L ); } catch (Exception e) { logger.log( Level.INFO, "Hilo de cambio de pantalla interrumpido" ); }  // 1 d閏ima
			}
			logger.log( Level.INFO, "Final de hilo de actualizaci髇 de pantalla" );
		}
	}
